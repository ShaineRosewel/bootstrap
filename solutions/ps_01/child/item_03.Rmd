...
Repeat step 1 up to step 2.a. of the [Item 1 Solutions].
  
Replace 2.b. with this: Obtain $\frac{\hat{\beta_1}}{\hat{\beta_3}}$ from the $B$ OLS estimates for each $b$ bootstrap dataset.
